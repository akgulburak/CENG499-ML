...
#gra3.render('avg_gini_index_preprune.pdf')
#gra4.render('avg_gini_index_no_preprune.pdf')
#Uncommenting them in the main function
#results in drawing the trees also, or
#only the prediction results would show up
###

#Uncomment below for tree construction and prediction
#main()
